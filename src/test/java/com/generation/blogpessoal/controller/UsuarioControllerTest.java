...
//Checa se o Status Code da Resposta foi CREATED -> 201
	...
	/*@Test
	@Order(5)
	@DisplayName("Logar todos os Usuários")
	public void deveLogarTodosUsuarios() {

		usuarioService.cadastrarUsuario(new Usuario(0L, "Janaina", "janaina_luziana@email.com.br", "janaina123",
				"https://i.imgur.com/yDRVeK7.jpg"));

		HttpEntity<UsuarioLogin> requisicao = new HttpEntity<UsuarioLogin>(new UsuarioLogin(0L, "", "janaina_luziana@email.com.br", "janaina123"));
